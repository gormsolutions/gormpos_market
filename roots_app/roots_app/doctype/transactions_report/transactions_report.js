...
function get_statement_details(frm) {
    ...
    frappe.call({
        method: 'roots_app.custom_api.transaction_report_api.get_transaction_report_gl',
        args: {
            transaction_id: frm.doc.transaction_id,
            from_date: frm.doc.from_date,
            to_date: frm.doc.to_date,
    ...
    frappe.call({
        method: 'roots_app.custom_api.transaction_report_api.get_daily_totals',
        args: {
            from_date: frm.doc.from_date,
            to_date: frm.doc.to_date,
    ...
    // frappe.call({
    //     method: "roots_app.custom_api.transaction_report_api.fetch_stock_entry_ledger_data", // Update with the actual path
    //     args: {
    //         from_date: frm.doc.from_date,
    //         to_date: frm.doc.to_date,
    //         cost_center: frm.doc.station
